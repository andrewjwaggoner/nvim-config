...
vim.keymap.set('n', '<Leader><Bar>', '<Cmd>vsplit<CR>', { silent = true })
...
vim.keymap.set('n', '<Leader>co',      '<Cmd>ColorschemeNext<CR>', { silent = true })
vim.keymap.set('n', '<Leader>dg'       , '<Cmd>diffget<CR>', { silent = true })
vim.keymap.set('n', '<Leader>do'       , '<Cmd>windo diffoff<CR>', { silent = true })
vim.keymap.set('n', '<Leader>dp'       , '<Cmd>diffput<CR>', { silent = true })
vim.keymap.set('n', '<Leader>dw'       , '<Cmd>windo diffthis<CR>', { silent = true })
vim.keymap.set('n', '<Leader>ee'       , '<Cmd>!clip-encode<CR>', { silent = true })
...
vim.keymap.set('n', ',', ':normal gJi <ESC>',{ silent = true })
