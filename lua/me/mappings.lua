...
nmap('<Leader>cg', cmd('!git commit -a'), stdopts)
...
nmap('<Leader>hh', cmd('GitMessenger'), stdopts)
nmap('<Leader>ja', cmd(':call jupyter_ascending#execute_all()'), stdopts)
nmap('<Leader>je', cmd(':call jupyter_ascending#execute()'), stdopts)
nmap('<Leader>jk', cmd('Jupyter kill'), stdopts)
nmap('<Leader>jl', cmd('Jupyter on'), stdopts)
nmap('<Leader>jr', cmd(':call jupyter_ascending#restart()'), stdopts)
